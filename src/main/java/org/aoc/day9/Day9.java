...
public class Day9 {
    ...
    public static void main(String[] args) {
        ArrayList<Long> input = InputReader.convertFileContentToLong(InputReader.readInputFile("day9"));
    ...
    private static long part1(ArrayList<Long> input) {
    ...
    private static long part2(ArrayList<Long> input, long invalidNumber) {
